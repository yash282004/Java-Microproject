...
/*
	<applet code=Demo10.class
			width=1920
			height=	1080>
	</applet>
*/

public class Demo10 extends Applet implements ActionListener, ItemListener 
{
	class info
	{
		String month;
	...
	Label arp[]=new Label[12];
    TextField T1, T2;
	TextField enterPrevReading,enterCurrentReading,consumedReading;
    Button B1,logout,exit,get,next,previous,generateBill,annualReport,generateGraph;
    ...
    public void init()
	{
		...
		generateGraph.setBackground(new Color(255, 51, 51));
		...
		for(int i=0;i<12;i++)
		{
			arp[i].setBackground(Color.white);
		}
		...
		generateGraph.setBounds(1160,560,100,30);
		
		for(int i=0;i<12;i++)
		{
			arp[i].setBounds(1500,150+i*30,150,30);
		}
	...
	public void paint(Graphics g) 
	 {
		...
		{	// Draw the background image
				...
				if(userName.equals(userEnteredID) && password.equals(userEnteredPassword)) 
				{
					...
					g.drawLine(640,0,640,540);
					g.drawLine(0,540,1280,540);
					g.drawLine(50,590,30,610);
					g.drawLine(50,590,70,610);
					
					g.drawLine(50,590,50,980);
					
					g.drawLine(50,980,1230,980);
					g.drawLine(1230,980,1210,960);
					g.drawLine(1230,980,1210,1000);
				...
				else
				{
					...
					if(userEnteredID.length()==0 && userEnteredPassword.length()==0)//1536 width 798 height
					{
						...
						g.drawString("Please Enter Username and Password",780,650);
					...
					else if(userEnteredID.length()==0 )
					{
						...
						g.drawString("Please Enter Username ",780,650);
					}
					else if(!userEnteredID.equals(userName))
					{
						g.setColor(Color.white);

						g.drawString("Incorrect Username ",780,650);
					}
					else if(userEnteredPassword.length()==0)
					{
						g.setColor(Color.white);

						g.drawString("Please Enter Password",780,650);
					}
					...
					else if(!userEnteredPassword.equals(password))
					{
						...
						g.drawString("Incorrect Password ",780,650);
					}
				}
			}
		}
